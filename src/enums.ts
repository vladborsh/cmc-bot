...
export enum LogMessageType {
  ...
  WS_SESSION_RENEW = 'WS_SESSION_RENEW',
  WS_EPIC_EVENT = 'WS_EPIC_EVENT',
  ALERT = 'ALERT',
  WS_ERROR = 'WS_ERROR',
  WS_ON_MESSAGE_ERROR = 'WS_ON_MESSAGE_ERROR',
  WS_PARSE_ERROR = 'WS_PARSE_ERROR',
  WS_SESSION_ERROR = 'WS_SESSION_ERROR',
  WS_BID_ASK_ERROR = 'WS_BID_ASK_ERROR',
  UNKNOWN_SYMBOL_ERROR = 'UNKNOWN_SYMBOL_ERROR',
  LAST_CHART_DATA_ERROR = 'LAST_CHART_DATA_ERROR',
  CHART_IMAGE_ERROR = 'CHART_IMAGE_ERROR',
  TECH_INDICATOR_ERROR = 'TECH_INDICATOR_ERROR',
}
