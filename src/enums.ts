...
export enum BotStates {
  ...
  ACCEPT_ASSET_CHART_NAME = 'ACCEPT_ASSET_CHART_NAME',
  FETCH_ASSET_CHART = 'FETCH_ASSET_CHART',
...
export enum BotTransitions {
  ...
  ADD_ASSET_TO_WATCH_LIST = 'ADD_ASSET_TO_WATCH_LIST',
  REMOVE_ASSET_FROM_WATCH_LIST = 'REMOVE_ASSET_FROM_WATCH_LIST',
  VIEW_WATCH_LIST = 'VIEW_WATCH_LIST',
  ADD_ASSET_TO_WATCH_LIST_ACCEPT_NAME = 'ADD_ASSET_TO_WATCH_LIST_ACCEPT_NAME',
